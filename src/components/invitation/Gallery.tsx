    ...
    <section id="gallery" className="section-pad relative">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="reveal columns-2 gap-3 sm:gap-4">
          {images.map((image, index) => (
            ...
            >
              <span className="relative block overflow-hidden rounded-2xl p-[1.5px] bg-gold-sheen">
      ...
      {current && (
        ...
        >
          ...
          <figure
            className="max-h-[88vh] w-full max-w-4xl px-4 text-center"
          ...
          >
            ...
            <img
              ...
              className="mx-auto max-h-[78vh] w-auto animate-scaleIn rounded-xl object-contain shadow-2xl"
            />
