  ...
  return (
    <section id="blessing" className="relative overflow-hidden">
      ...
      <div className="section-pad relative mx-auto max-w-2xl text-center">
        <Lotus className="reveal mx-auto h-8 w-8 animate-floaty text-gold" />

        <p className="reveal mt-8 text-sm leading-loose text-ink/80 khmer-wrap sm:text-base">
          {wedding.blessingThanks}
        </p>

        <GoldDivider className="my-8" width="max-w-[180px]" />

        <p className="reveal text-sm leading-loose text-ink/80 khmer-wrap sm:text-base">
          {wedding.blessingWish}
        </p>

        <div className="reveal mt-12">
          <p className="text-xs leading-loose text-ink/60 khmer-wrap sm:text-sm">
